...
function App() {
  const imageUrl1 = process.env.PUBLIC_URL + 'SIMMA HITESH.jpeg';
            ...
            <div className='row mt-5'>
              <div className='col-lg-6'>
                <div className='banner-title'>
                  <h1 className='title'>Hitesh Simma</h1>
...
• Data Analysis: R,NumPy, Pandas,Matplotlib</p>
      ...
      <div className='container section' id='contactus'>
        ...
        <ul className='contact'>
          <li className='details'>Phone Number: -9550345774</li>
          <li className='details'>Gmail:- hit123ram@gmail.com</li>
          <li className='details'>Address:- Srikakulam, Andhra Pradesh, India, 518004</li>
        </ul>
      </div>
    </>
  );
